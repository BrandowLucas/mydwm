...
//volume controls
static const char *upvol[]   = { "amixer", "-D", "pulse", "sset", "Master", "5%+" };
static const char *downvol[] = { "amixer", "-D", "pulse", "sset", "Master", "5%-" };
static const char *mutevol[] = { "amixer", "-D", "pulse", "sset", "Master", "toggle" };
...
static Key keys[] = {
    ...
    { MODKEY|ShiftMask,                 XK_F5,     spawn,          {.v = mutevol } },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
